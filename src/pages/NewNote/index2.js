...
const phizIcon = require('../../assets/images/ad.png');
const htmlIcon = require('../../assets/images/ad.png');
...
class ExampleClass extends React.Component {
  ...
  constructor(props) {
    ...
    // this.onHome = that.onHome;
    // this.save = that.save;
    // this.onTheme = that.onTheme;
    // this.onPressAddImage = that.onPressAddImage;
    // this.onInsertLink = that.onInsertLink;
    // this.onLinkDone = that.onLinkDone;
    // this.themeChange = that.themeChange;
    // this.handleChange = that.handleChange;
    // this.handleHeightChange = that.handleHeightChange;
    // this.insertEmoji = that.insertEmoji;
    // this.insertHTML = that.insertHTML;
    // this.insertVideo = that.insertVideo;
    // this.handleEmoji = that.handleEmoji;
    // this.onDisabled = that.onDisabled;
    // this.editorInitializedCallback = that.editorInitializedCallback;
  }
